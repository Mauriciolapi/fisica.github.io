        ...
        document.addEventListener("mousemove", (e) =>{
            ...
            arrows.forEach(arrow => {
                ...
                if(getDistanceBetweenElements(arrow, x) < getDistanceBetweenElements(arrow, y)){
                    ...
                    if((getDistanceBetweenElements(arrow, x) && getDistanceBetweenElements(arrow, y)) < 200){
                    }
                    ...
                    if((getDistanceBetweenElements(arrow, y) && getDistanceBetweenElements(arrow, x)) < 200){
                    }
                }
